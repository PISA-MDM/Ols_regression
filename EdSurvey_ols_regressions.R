...
######################################################
# Running ols regressions for global competence scales 
...
######################################################
## Effect of global competence while controlling for control.vars
######################################################
...
######################################################
# 1. Create binary immig variable
######################################################
...
length(full.cases) # 2735

# Dataset further reduced to 2735 cases
